...
#%% Path Info
# setname='xmde7'
# qq = glob.glob('E:/Sets/' + setname + '/noscar*.png') #read all noscar images
# rr = glob.glob('E:/Sets/' + setname + '/scar*.png') #read all scar images
# # bb = glob.glob('E:/Sets/' + setname +'/*.png') #read all images
# bb = glob.glob('E:/Sets/xmde8/*.png')
...
# qq = glob.glob('E:/Sets/notm opti/*.png') #makes list of negative cases
# rr = glob.glob('E:/Sets/yetm opti/*.png') #makes list of positive cases
# bb = glob.glob('E:/Sets/basecheck/*.png') #makes list of external testing dataset cases
# switch = 'LWPtest'
...
#%% Define threshold
# tset=[0.70,0.71,0.72,0.73,0.74,0.75,0.76,0.77,0.78,0.79,0.80,0.81,0.82,0.83,0.84,0.85]
# tset=[0.79]
tset=[0.90]
# tset=[0.86,0.87,0.88,0.89,0.90]
...
for thrsh in tset:
    ...
    for num in N:
        ...
        for patim in range(num):
            ...
            # using base files, use the "switch" set as the source files with the same name
            # qqq = ['E:/Sets/' + switch + '\\' + os.path.basename(i) for i in qqq]
            # rrr = ['E:/Sets/' + switch + '\\' + os.path.basename(i) for i in rrr]
